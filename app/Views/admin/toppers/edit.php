            ...
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <form method="post" action="" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?= $toppers->id ?>" required>
                       <div class="form-group row">
                                    ...
                                    <?php if (!empty($courses)): ?>
                                        <?php foreach ($courses as $course): ?>
                                            <option value="<?= $course->id ?>" 
                                                <?= $course->id == $toppers->course_id ? 'selected' : '' ?>>
                                                <?= esc($course->title) ?>
                                            </option>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
                        ...
                        <div class="form-group  row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="name" class="form-control" placeholder="Enter Here" required value="<?=$toppers->name?>">
                            </div>
                        </div>
                        <div class="form-group  row">
                            <label class="col-sm-2 col-form-label">Comment :</label>
                            <div class="col-sm-10">
                                <textarea name="comment" class="form-control" placeholder="Enter Here"><?=$toppers->comment?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group  row">
                            ...
                            <div class="col-sm-2">
                                <input type="hidden" name="old_file" value="<?= ALUMINI_IMAGE.$toppers->image ?>">
                                <img src="<?= ALUMINI_IMAGE . $toppers->image ?>" height="50px">
                            </div>
                        </div>
