...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-lg-2">
        <a href="admin/placements" class="btn btn-sm btn-primary float-right mt-3"><i class="fa fa-list"></i></a>
    </div>
</div>
                ...
                <div class="ibox-content">
                    <form method="post" action="" enctype="multipart/form-data">
                       ...
                       <div class="form-group  row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="placed_at" class="form-control" placeholder="Enter Here"  value="<?=post_value('name')?>">
                            </div>
                        </div>
                        <!-- <div class="form-group  row">
                            <label class="col-sm-2 col-form-label">Linked In Link :</label>
                            <div class="col-sm-10">
                                <input type="text" name="linkedInLink" class="form-control" placeholder="Enter Here"  value="<?=post_value('name')?>">
                            </div>
                        </div> -->
                        ...
                        <!-- <div class="form-group  row">
                            ...
                            <div class="col-sm-6">
                                 <input type="text" name="videolink" class="form-control" placeholder="Enter Here" value="">
                            </div>
                        </div> -->
                        <div class="form-group  row">
