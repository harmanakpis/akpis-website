                ...
                <div class="ibox-content">
                    <form method="post" action="" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <textarea name="banner_title" id="banner_title" class="form-control" placeholder="Enter Here"><?= post_value('banner_title') ?></textarea>
                            </div>
                            <div class="col-sm-4">
                                <textarea name="video_title" id="video_title" class="form-control" placeholder="Enter video title"><?= post_value('video_title') ?></textarea>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <textarea name="enquiry_title" id="enquiry_title" class="form-control" placeholder="Enter Here" ><?= post_value('enquiry_title') ?></textarea>
                            </div>
                            <div class="col-sm-6">
                                <textarea name="enquiry_description" id="enquiry_description" class="form-control" placeholder="Enter Here" ><?= post_value('enquiry_description') ?></textarea>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group  row">
                            ...
                            <div class="col-sm-10">
                                <textarea name="page_title" id="page_title" class="form-control" placeholder="Enter Here"><?= post_value('page_title') ?></textarea>
                            </div>
                        </div>
                        <div class="form-group  row">
                        ...
                        <div class="form-group  row">
                            ...
                            <div class="col-sm-10">
                                <textarea name="small_description" id="small_description" class="form-control" placeholder="Enter Here" rows="3"><?=post_value('small_description')?></textarea>
                            </div>
                        </div>
