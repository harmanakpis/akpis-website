                ...
                <div class="ibox-content">
                     <form method="post" action="" enctype="multipart/form-data">
                        <div class="form-group  row">
                            ...
                            <div class="col-sm-10">
                                <input type="hidden" name="id" value="<?= $webinars->id ?>" required>
                                <input type="text" name="name" class="form-control" placeholder="Enter Here" required  value="<?=$webinars->name?>">
                            </div>
                        </div>
                        <div class="form-group  row">
                            <label class="col-sm-2 col-form-label">Add Date :</label>
                            <div class="col-sm-10">
                                <input type="date" name="date" id="datepicker" class="form-control" placeholder="Add Date" value="<?=$webinars->webinar_date?>" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group  row">
                            ...
                            <div class="col-sm-10">
                                <input type="time" name="time" id="time" class="form-control" placeholder="Add Time" value="<?=$webinars->webinar_time?>" required>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group  row">
                            ...
                            <div class="col-sm-2">
                                <input type="hidden" name="old_file" value="<?= ALUMINI_IMAGE.$webinars->image ?>">
                                <img src="<?= ALUMINI_IMAGE . $webinars->image ?>" height="50px">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                         <div class="form-group  row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="webinar_link" id="webinar_link" class="form-control" placeholder="Add webinar video link" value="<?=$webinars->webinar_link?>">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group row">
