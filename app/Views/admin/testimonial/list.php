              ...
              <tbody>
                <?php foreach ($testimonials as $k => $testimonial) { ?>
                  <tr>
                    ...
                    <td><a href="<?= TESTIMONIAL_IMAGE . $testimonial->image ?>" title="<?= $testimonial->name ?>" class="pop-up">
                            <img alt="<?= $testimonial->name ?>" src="<?= $image->rimg(TESTIMONIAL_IMAGE . $testimonial->image, ['height' => 50, 'width' => 50, 'alt' => get_initial($testimonial->name), 'return' => true, 'crop' => true]) ?>">
                        </a>
                    </td>
                    ...
                    <td>
                        <a href="admin/testimonial/edit/<?= $testimonial->id ?>" class="btn btn-outline btn-primary btn-sm dim"><i class="fa fa-edit"></i></a>
