                ...
                <div class="ibox-content">
                    <form method="post" action="" enctype="multipart/form-data">
                                    ...
                                    <?php if (!empty($courses)): ?>
                                        <?php foreach ($courses as $course): ?>
                                            <option value="<?= $course->id ?>" 
                                                <?= $course->id == $testimonial->course_id ? 'selected' : '' ?>>
                                                <?= esc($course->title) ?>
                                            </option>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
                        ...
                        <div class="form-group  row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="name" class="form-control" placeholder="Enter Here" required value="<?=$testimonial->name?>">
                            </div>
                        </div>
                        <div class="form-group  row">
                            <label class="col-sm-2 col-form-label">Star :</label>
                            <div class="col-sm-10">
                                <input type="number" name="star" class="form-control" placeholder="Enter Here" required value="<?=$testimonial->star?>">
                            </div>
                        </div>
                        <div class="form-group  row">
                            <label class="col-sm-2 col-form-label">Comment :</label>
                            <div class="col-sm-10">
                                <textarea name="comment" class="form-control" placeholder="Enter Here"><?=$testimonial->comment?></textarea>
                            </div>
                        </div>
