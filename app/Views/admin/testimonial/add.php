                ...
                <div class="ibox-content">
                    <form method="post" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group  row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" name="star" class="form-control" placeholder="Enter Here" required value="<?=post_value('star')?>">
                            </div>
                        </div>
                        <div class="form-group  row">
                            <label class="col-sm-2 col-form-label">Comment :</label>
                            <div class="col-sm-10">
                                <textarea name="comment" class="form-control" placeholder="Enter Here"><?=post_value('comment')?></textarea>
                            </div>
                        </div>
