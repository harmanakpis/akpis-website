                ...
                <div class="ibox-content">
                    <form method="post" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group  row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" name="order_no" class="form-control" placeholder="Enter Here" required value="<?=$details->order_no?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group  row">
                            ...
                            <div class="col-sm-10">
                                <textarea name="description" id="description" class=" form-control" placeholder="Enter Here" ><?=$details->description?></textarea>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
