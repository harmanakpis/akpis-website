<div class="row wrapper border-bottom white-bg page-heading">
  ...
  <div class="col-lg-2">
      <a href="admin/akpiscourse/add" class="btn btn-sm btn-primary float-right mt-3"><i class="fa fa-plus"></i></a>
  </div>
</div>
              ...
              <tbody>
                <?php foreach ($courses as $k => $record) { ?>
                  <tr>
                    ...
                    <td>                      
                         <img alt="<?= $record->title ?>" src="<?= $image->rimg(COURSE_IMAGE . $record->banner_image, ['height' => 50, 'width' => 100, 'alt' => get_initial($record->title), 'return' => true, 'crop' => true]) ?>">
                    </td>
                    <td class="center">
                    ...
                    <td>
                        ...
                        <a href="admin/newcourse/edit/<?= $record->id ?>" class="btn btn-outline btn-primary btn-sm dim"><i class="fa fa-edit"></i></a>
