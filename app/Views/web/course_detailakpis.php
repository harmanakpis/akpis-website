    ...
    <section class="cpa_usa_ca">
        <div class="container">
            ...
            <div class="cpa_use_btn text-center py-3">
                <?php if (!empty($course->prospectus)): ?>
                    <a href="<?= COURSE_IMAGE.$course->prospectus; ?>"  class="btn btn-primary" target='_blank'>
                        Download Free US CPA Prospectus 
    ...
    <section class="Desktop_imgage_cpa">
        <div class="container-fluid px-0">
            <div class="row">
                <div class="col-12">
                    <img src="<?=base_url()?>/assets/image/logo/Partnership-Banner.jpg" alt="img" class="img-fluid">
    ...
    <section class="backer_choose">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-5 image-wrapper">
                    <div class="youtube-icon">
                        <a onclick="show_video('https://www.youtube.com/embed/BpGHn8B_rvM')" class="video-btn">  <img src="<?=base_url()?>/assets/image/logo/youtube.png" alt="img" class="img-fluid"> </a>
                    </div>
                    <img class="course-image" src="<?=base_url()?>/assets/image/desktop-image/hqdefault.jpg" alt="Course Overview">
                </div>
                ...
                <div class="col-md-7">
                    <div class="para_bakerchoose">
                        <h2><?= !empty($course->glimp_title) ? $course->glimp_title : '' ?></h2>
                        <h4><?= !empty($course->glimp_subtitle) ? $course->glimp_subtitle : '' ?></h4>
                        <p><?= !empty($course->glimp_description) ? $course->glimp_description : '' ?>.</p>
                    </div>
                </div>
            ...
            <div class="row py-4 g-4">
                 <?php  $gfeatures = [];
                  if(!empty($course->glimpe_features)){
                    $gfeatures = json_decode($course->glimpe_features);
                  }
                    if (!empty($gfeatures)) {
                        foreach ($gfeatures as $gfeature) {
                    ?>
                        <div class="col-md-4">
                            <div class="cpa_evaluation">
                                 <?= !empty($gfeature->icon) ? $gfeature->icon : '' ?>
                                <h2><?= !empty($gfeature->title) ? htmlspecialchars($gfeature->title) : '' ?></h2>
                                <p><?= !empty($gfeature->description) ? htmlspecialchars($gfeature->description) : '' ?></p>
                            </div>
                        </div>
                    <?php
                        }
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="global_mentor">
                                <img src="<?=base_url()?>/assets/image/logo/ab.png" alt="img" class="img-fluid">
                            </div>
                ...
                <div class="col-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="global_youtube_imgmain">
                                <div class="global_youtubeimg">
                                    <img src="<?=base_url()?>/assets/image/desktop-image/course-overview.jpg" alt="img" class="img-fluid">
                        ...
                        <div class="col-md-6">
                            <div class="global_youtube_imgmain">
                                <div class="global_youtubeimg">
                                    <img src="<?=base_url()?>/assets/image/desktop-image/bFykzbHy_n4.jpg" alt="img" class="img-fluid">
                                     <div class="youtube-icon">
                                        <a onclick="show_video('https://www.youtube.com/embed/bFykzbHy_n4')" class="video-btn">  <img src="<?=base_url()?>/assets/image/logo/youtube.png" alt="img" class="img-fluid"> </a>
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="global_youtube_imgmain">
                                <div class="global_youtubeimg">
                                    <img src="<?=base_url()?>/assets/image/desktop-image/d0VjQchoAXs.jpg" alt="img" class="img-fluid">
                                     <div class="youtube-icon">
                                        <a onclick="show_video('https://www.youtube.com/embed/d0VjQchoAXs')" class="video-btn">  <img src="<?=base_url()?>/assets/image/logo/youtube.png" alt="img" class="img-fluid"> </a>
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="global_youtube_imgmain">
                                <div class="global_youtubeimg">
                                    <img src="<?=base_url()?>/assets/image/desktop-image/G1dWWqPKIoo.jpg" alt="img" class="img-fluid dddd">
                                     <div class="youtube-icon">
                                        <a onclick="show_video('https://www.youtube.com/embed/G1dWWqPKIoo')" class="video-btn ddd">  <img src="<?=base_url()?>/assets/image/logo/youtube.png" alt="img" class="img-fluid"> </a>
                                    </div>
            ...
            <div class="row">
                <div class="col-12 col-md-12 col-lg-6 col-xl-6">
                    <div class="visionary_image">
                        <img src="<?=base_url()?>/assets/image/logo/sha.jpg" alt="img" class="visionary_img">
                        <h4> <span>
                ...
                <div class="col-12 col-md-12 col-lg-6 col-xl-6">
                    <div class="pathway_findtxt">
                        <ul>
                            ...
                            <li>
                                REG — Taxation and Regulation exam</li>
                            <li>TCP — Tax Compliance and Planning
                            </li>
                            <li>
                                ISC — Information Systems and Controls</li>
                            <li>
                                BAR — Business Analysis & Reporting</li>
                        </ul>
                    </div>
                </div>
                <div class="col-12 col-md-12 col-lg-6 col-xl-6">
                    ...
                    <div class="pricing-wrap">
                        <div class="cma_exam_price">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    <p class="mb-2">
                                        <strong>Akpis Live Classes + Gleim CPA Review Program</strong><br>
                                        The only institute in India offering both Indian & US lecture software. Access expert live training, Gleim CPA Review resources, all four modules, physical textbooks, pre-recorded lectures, and PassMaster Software with 7,000+ MCQs and simulations, plus progress tests and mock exams.
                                    </p>
            ...
            <div class="row py-4">
                <div class="col-12">
                    <div class="impact_akspit">
                        <h2 class="akspit_imapct_heading">The Impact of Akpis’s Training</h2>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    <div class="cpa_mcq_counting">
                        <img src="<?php echo base_url();?>/assets/image/logo/sucess-thumb1.jpg" alt="img" class="img-fluid rounded-4">
                    </div>
                    ...
                    <div class="testomoinal_slider">
                        ...
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <div class="testomonial_img">
                                    <img src="<?php echo base_url();?>assets/image/students/1.jpg" alt="John Doe" class="img-fluid rounded-circle" width="80">
                        ...
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <div class="testomonial_img">
                                    <img src="<?php echo base_url();?>assets/image/students/4.jpg" alt="Jane Smith" class="img-fluid rounded-circle" width="80">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <div class="explore_webinars_banner">
                        <img src="<?php echo base_url();?>assets/image/students/learning.jpg" alt="img" class="img-fluid">
        ...
        <div class="container">
            <div class="row align-items-center insight_student_main">
                ...
                <div class="col-md-6 text-center">
                    <img src="<?php echo base_url();?>assets/image/desktop-image/IFRS+best.jpg" alt="CPA Insights" class="img-fluid rounded-3 shadow">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="cpa_prometric_img text-center">
                    <img src="<?php echo base_url();?>assets/image/logo/allcity image.png" alt="img" class="img-fluid">
                </div>
    ...
    <section class="learning_today_cma my-5">
        <div class="container">
            <div class="row start_cma_today text-center">
                ...
                <p>The US CPA sets you apart in a competitive job market—and with Akpis’s expert-led coaching and proven track record, you can fast-track your success!</p>
                    ...
                    <div class="form_heading_learning p-4 shadow-lg rounded-3 bg-light">
                        ...
                        <form action="">
                            ...
                            <p class="small mt-3 text-muted">
                                By submitting, I authorize <strong>Akpis Institute</strong> & its representatives to contact me
