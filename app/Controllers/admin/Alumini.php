...
class Alumini extends AdminController {
    ...
    public function for() {
        ...
        return $this->layout->view('admin/alumini/list_for', $data);
    }
    ...
    public function add_for(){
        ...
        return $this->layout->view('admin/alumini/add_for');
    }
    ...
    public function edit_for($id) {
        ...
        return $this->layout->view('admin/alumini/edit_for', $data);
    }
