...
$subject="AKPIS- EA Course Enquiry";
...
$headers .= "X-Mailer: PHP/" . phpversion();
	...
	//$email->addTo('rishabh.goswami@newvisiondigital.co');
    $email->addCc($cc,"");
    ...
    try{
      ...
      if($response->statusCode()==202){
        header("Location:https://akpisprofessionals.com/promotion/new-ea/thankyou/"); 
      }
    }catch(\Throwable $th){
      header("location:https://akpisprofessionals.com/promotion/new-ea/");
    }
