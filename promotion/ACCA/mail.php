...
// Additional headers
    ...
    try{
      ...
      if($response->statusCode()==202){
        echo 'hi';
        header("Location:https://wordpress-1285171-4657113.cloudwaysapps.com/promotion/ACCA/thankyou.html"); 
      }
    }catch(\Throwable $th){
      header("location:https://wordpress-1285171-4657113.cloudwaysapps.com/promotion/ACCA/");
    }
    print_r($response);
