...
if(isset($_POST['send'])){
    ...
    $subject="Download Brochure for CIA";
    ...
    try{
      ...
      if($response->statusCode()==202){
        ...
        readfile("https://wordpress-1285171-4657113.cloudwaysapps.com/promotion/new-CIA/docs/System-for-Success-CIA17.pdf");

        // header("Location:https://wordpress-1285171-4657113.cloudwaysapps.com/promotion/new-CIA/thankyou.php"); 
      }
    }catch(\Throwable $th){
      header("location:https://wordpress-1285171-4657113.cloudwaysapps.com/promotion/new-CIA/");
    }
}
