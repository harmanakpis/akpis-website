...
<script>
  ...
  gtag('config', 'UA-238854941-1');
    ...
    <title>Australia CPA - AKPIS</title>
...
<body>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <p>The CMA US test, also known as Certified Management Accountant, is a two-part exam conducted by the Institute of Cost Accountants of India(ICAI). Both the parts of CMA comprise of two 100 MCQs and 2 Essays. The MCQs topics are thereby divided into 6 sections. To know more about it, reach out to the expert faculty at AKPIS Professionals. </p>
    ...
    <!-- <a href="javascript:void(0);" class="fix-btn2" onclick="myFunction()">Enquire Now</a> -->
