...
if(isset($_POST['send'])){
    ...
    $subject="Download Brochure for Australia CPA";
    ...
    try{
      ...
      if($response->statusCode()==202){
        ...
        readfile("https://wordpress-1285171-4657113.cloudwaysapps.com/promotion/new-Australia CPA/docs/GLEIM CPA.pdf ");

        // header("Location:https://wordpress-1285171-4657113.cloudwaysapps.com/promotion/new-Australia CPA/thankyou.php"); 
      }
    }catch(\Throwable $th){
