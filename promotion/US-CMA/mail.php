...
$headers .= "X-Mailer: PHP/" . phpversion();
    ...
    try{
      ...
      if($response->statusCode()==202){
        header("Location:https://wordpress-1285171-4657113.cloudwaysapps.com/promotion/US-CMA/thankyou.html"); 
      }
    }catch(\Throwable $th){
      header("location:https://wordpress-1285171-4657113.cloudwaysapps.com/promotion/US-CMA/");
    }
