...
$subject="AKPIS- US-CPA Subscriber Email";
...
// Additional headers
	...
	require_once('../../../send-in-blue/vendor/autoload.php');
			...
			try {
				...
				header("Location:https://akpisprofessionals.com/promotion/new-US-CPA/thankyou"); 
			} catch (Exception $e) {
...
/*
    ...
    try{
      ...
      if($response->statusCode()==202){
        header("Location:https://wordpress-1285171-4657113.cloudwaysapps.com/promotion/new-US-CPA/thankyou"); 
      }
    }catch(\Throwable $th){
