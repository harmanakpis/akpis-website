...
<script>
  ...
  gtag('config', 'UA-238854941-1');
    ...
    <meta property="og:site_name" content="US-CMA - AKPIS">

    <meta property="og:url" content="https://akpisprofessionals.com/promotion/new-US-CMA/">

    <meta property="og:title" content="US-CMA - AKPIS" />

    <meta property="og:description" content="The CMA US test, also known as Certified Management Accountant, is a two-part exam conducted by the Institute of Cost Accountants of India(ICAI)." />

    <meta property="og:image" content="https://akpisprofessionals.com/promotion/new-US-CMA/img-2/LP-2-Banner-2.jpg" />

    <meta property="og:image:secure_url" content="https://akpisprofessionals.com/promotion/new-US-CMA/img-2/LP-2-Banner-2.jpg" />
...
<body onload="myForm()">
        ...
        <div class="swiper mySwiper">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    ...
                    <img src="img-2/LP-2-Banner-1.jpg" alt="banner-2">

                </div>

                <div class="swiper-slide">

                    <img src="img-2/LP-2-Banner-2.jpg" alt="banner-3">

                </div>

                <div class="swiper-slide">

                    <img src="img-2/LP-2-Banner-3.jpg" alt="banner-4">
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    ...
                    <h3>ENROLL TODAY <strong>WRITE YOUR SUCCESS STORY WITH AKPIS</strong></h3>
                    ...
                    <ul>
                        ...
                        <li>Globally recognized certification in CMA USA.</li>

                        <li>Make a career as a financial analyst, financial controller or renowned cost accountant. </li>

                        <li>Get online live course training from experts at AKPIS. </li>

                        <li>Interactive classroom experience with doubt sessions.</li>

                        <li>Exam-oriented learning and problem-solving.</li>
    ...
    <section class="section-5">
        ...
        <div class="container">
            ...
            <div class="video-s">
                <iframe src="https://www.youtube.com/embed/XXFTN5X9gC0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
            ...
            <div class="row py-5">
                ...
                <div class="col-md-4">
                    ...
                    <div class="iconbox" data-aos="fade-down" data-aos-duration="2000">
                        ...
                        <p>We have been offering innovative US-CMA classes that are phenomenally designed as per the dynamic tax laws, current trends and requirements. </p>
            ...
            <div class="row">
                ...
                <div class="col-md-6 position-relative">
                    ...
                    <ul>
                        ...
                        <li>Uplift your skills and upgrade your Curriculum vitae with a CMA USA Course from AKPIS Professionals. </li>

                        <li>The pandemic has taught us to get digital. So, we have made learning easily accessible with both offline and online classes.</li>

                        <li>Grab the opportunity to learn from the comfort of your home with online classes.</li>

                        <li>Meet like-minded people and teachers at AKPIS with offline classes in Delhi.</li>
                        <li>Adjust your batch timing and learn at your own pace. </li>
                    </ul>

                    <h6>A phenomenal pass percentage: </h6>

                    <ul>

                        <li>Get the right guidance from the AKPIS Professionals. All you have to do is join the leading bunch of Certified Management Accountants USA in Delhi. </li>

                        <li>AKPIS has been a renowned leader in giving the best CMA USA courses to its students. </li>

                        <li>With an 85% pass percentage, our students consistently raise the bar higher every year.</li>

                        <li>Consistent results from all the students after learning from the AKPIS Professionals CMA course.</li>

                    </ul><span id="dots"> </span>

                    <span id="more">

                        <h6>Professional and skilled instructors:</h6>

                        <ul>

                            <li>With our world-class faculty and top-notch instructors, we at AKPIS will help you crack the CMA exams in one go. We focus on infusing balanced learning with a practical approach for your better understanding. </li>

                            <li>Work meticulously for 16-18 hours a week to get the CMA certification.</li>

                            <li>With comprehensive study material, you can crack the two toughest exams in merely 6 months. </li>

                            <li>Open the doors to being a financial controller, financial analyst, and cost accountant after this course. </li>

                        </ul>

                        <h6>Fully revised exam papers in accordance with the latest changes:</h6>

                        <ul>

                            <li>As you join the AKPIS Professional CMA USA course, you pave your way to an ocean of practice sets for preparation.</li>

                            <li>Get detailed and handwritten notes for a deeper understanding. </li>

                            <li>We design practice sets in accordance with the changes in the pattern, so you
                                 can never go wrong while revising. Make use of the fully-revised sets to build up your speed and accuracy. </li>

                            <li>Get guided on note-making. The better the notes, the better the preparation. Learn from the right sources and write your success story in golden letters. </li>
                        </ul>
                    ...
                    <div class="accordion" id="accordionExample">
                        <div class="card">
                            <div class="card-header " id="headingOne">
                                <h5 class="clearfix mb-0">
                                    <a href="" class="heading btn btn-link collapsed" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Will I be able to travel the world and make a living simultaneously? </a>
                                </h5>
                            </div>
                            <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                                <div class="card-body"> Indeed, as the certification of Certified Management Accountant USA is a globally recognised one, one can make the most of the opportunity and work from any place on this globe.
                        ...
                        <div class="card">
                            <div class="card-header " id="headingTwo">
                                <h5 class="clearfix mb-0">
                                    <a href="" class="heading btn btn-link collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">Am I eligible to do the CMA USA course after my 12th?</a>
                                </h5>
                            </div>
                            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                                <div class="card-body">Of course, one can start the preparation for the CMA course after completing their 12th. One is eligible to take the exam for the same if they have passed the 12th standard from any stream. So, against the common belief,
                                    one is not expected to get a PG degree.
                        ...
                        <div class="card">
                            <div class="card-header " id="headingThree">
                                <h5 class="clearfix mb-0">
                                    <a href="" class="heading btn btn-link collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree">What will be my job profile after I get my CMA USA certification?</a>
                                </h5>
                            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <h3>AVAIL YOURSELF OF THE <strong>
                        UNLIMITED BENEFITS OF THE CMA USA CERTIFICATION IN 
                        6 MONTHS
                        </strong></h3>

                    <ul>

                        <li>START FROM SCRATCH: Don’t know where to start? Or not from a finance and accounting background? Worry no cause we at AKPIS Professionals have got you covered. We start from the ABC of management accounting so that every student
                            is able to comprehend and work towards their goal of making a career in finance and accounting.</li>

                        <li>ENJOY THE HEAPS OF DISCOUNTS: Be a scholar and get the chance of getting a scholarship at AKPIS. Hurry up, fun discount packages are awaiting!</li>

                        <li>COMPREHENSIVE TRAINING: No more worrying about half-cooked data. Our courses are comprehensive and handcrafted according to the CMA Part I and Part II.</li>

                        <li>PLACEMENT ASSISTANCE: We, at AKPIS Professionals, work in unison with MNCs and the Big 4’s, so that you are guaranteed a job after you get your CMA certification. </li>
            ...
            <div class="row mt-5">
                ...
                <div class="col-md-6">
                    ...
                    <h3>Time to introspect <strong> why AKPIS Professionals are the go-to guides for CMA: </strong></h3>

                    <ul>

                        <li>Decades of experience in the field of financing and auditing.</li>

                        <li>Most sought after faculty who are educationalists by passion.</li>

                        <li>World-class teachers who are internationally recognized and felicitated.</li>

                        <li>Avail of the various modes of teaching, ranging from interactive classes, self-learning classes and classroom training.</li>

                        <li>Make use of our mobile application for both iOs and Android and get access to all our handwritten notes, lectures, recorded classes, tests and MCQs.</li>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <img src="img-2/Ankur.png" alt="akpis" class="w-100" data-aos="zoom-in" data-aos-duration="3000">

                </div>

                <div class="col-md-4">

                    <img src="img-2/Anshu.png" alt="akpis" class="w-100" data-aos="zoom-in" data-aos-duration="3000">

                </div>

                <div class="col-md-4">

                    <img src="img-2/Eliga.png" alt="akpis" class="w-100" data-aos="zoom-in" data-aos-duration="3000">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <p>The CMA US test, also known as Certified Management Accountant, is a two-part exam conducted by the Institute of Cost Accountants of India(ICAI). Both the parts of CMA comprise of two 100 MCQs and 2 Essays. The MCQs topics are
                            thereby divided into 6 sections. To know more about it, reach out to the expert faculty at AKPIS Professionals. </p>
    ...
    <div class="banner-form load" id="downloadForm">
        ...
        <div class="form-inner">
            ...
            <h3>Download Brochure for US-CMA</h3>
