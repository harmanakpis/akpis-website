...
$subject="AKPIS- US-CMA Course Enquiry";
...
// Additional headers
	...
	require_once('../../../send-in-blue/vendor/autoload.php');
			...
			try {
				...
				header("Location:https://akpisprofessionals.com/promotion/new-US-CMA/thankyou"); 
			} catch (Exception $e) {
    ...
    try{
      ...
      if($response->statusCode()==202){
        header("Location:https://wordpress-1285171-4657113.cloudwaysapps.com/promotion/new-US-CMA/thankyou"); 
      }
    }catch(\Throwable $th){
      header("location:https://wordpress-1285171-4657113.cloudwaysapps.com/promotion/new-US_CMA/");
    }
*/
